...
class AuthServiceTest {
    ...
    void testLoginExitoso() {
        ...
        when(usuarioClient.validarCredenciales(
                new com.ticketti.bff.dto.usuario.ValidarCredencialesRequest("user@example.com", "password123")))
    ...
    void testLoginConCredencialesInvalidas() {
        ...
        when(usuarioClient.validarCredenciales(
                new com.ticketti.bff.dto.usuario.ValidarCredencialesRequest("user@example.com", "passwordIncorrecto")))
                .thenReturn(validacion);
    ...
    void testLoginConUsuarioNoEncontrado() {
        ...
        when(usuarioClient.validarCredenciales(
                new com.ticketti.bff.dto.usuario.ValidarCredencialesRequest("inexistente@example.com", "password123")))
                .thenReturn(null);
